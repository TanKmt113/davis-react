...
function ProjectCard({ item }) {
  return (
    <article className="portfolio-card w-full glass-card rounded-2xl overflow-hidden border border-white/5 bg-surface/30 backdrop-blur-xl transition-all duration-500 hover:-translate-y-1 hover:border-primary/20 hover:shadow-[0_16px_32px_rgba(59,130,246,0.12)] relative group h-[360px]">
      ...
      <div className="absolute inset-x-0 bottom-0 translate-y-[calc(100%-88px)] group-hover:translate-y-0 transition-transform duration-500 ease-out bg-surface/95 backdrop-blur-xl border-t border-white/5 pt-4 pb-5 px-5 z-20 flex flex-col justify-between h-[280px]">
        <div>
        ...
        <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-75 mt-3 pt-3 border-t border-white/5">
